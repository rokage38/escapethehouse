# MISSING: PUN — iOS release runbook

## Already configured

- Capacitor 8 native shell
- Proposed bundle ID: `com.rokage.missingpun`
- App name: MISSING: PUN
...
3. Confirm the bundle identifier is exactly `com.rokage.missingpun` and matches the App Store Connect record.
